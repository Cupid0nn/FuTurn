...
export class CreateUsuarioDto {
  ...
  @ApiProperty({ description: 'Contraseña (se almacenará en hash)', example: 'contraseña123' })
  contraseña: string;

  @IsOptional()
  @IsString()
  @ApiPropertyOptional({ description: 'Teléfono de contacto', example: '+5491123456789' })
  telefono?: string;

  @IsOptional()
  @IsString()
  @ApiPropertyOptional({ description: 'Dirección del usuario', example: 'Av. Siempreviva 742' })
  direccion?: string;
}
...
export class UpdateUsuarioDto {
  ...
  @IsString()
  @MinLength(6)
  @ApiPropertyOptional({ description: 'Nueva contraseña (se almacenará hasheada)' })
  contraseña?: string;
